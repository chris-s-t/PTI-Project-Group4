const canvas = document.getElementById("gameCanvas");
        ...
        function drawBoat() {
            ...
            ctx.drawImage(shipCharacter, -boat.width / 2, -boat.height / 2, boat.width, boat.height);
        ...
        function updateBoatMovement() {
            if (keysPressed['w']) boat.speed = Math.min(boat.speed + boat.acceleration, boat.maxSpeed);
            if (keysPressed['s']) boat.speed = Math.max(boat.speed - boat.acceleration, -boat.maxSpeed / 2);
